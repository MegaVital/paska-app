...
export const Catalogue: FC<Props> = () => {
    ...
    return (
        <div>
            <Grid sx={{ display: 'flex', flexDirection: 'row-reverse', justifyContent: 'space-between' }}>
                <FormControl sx={{ width: '250px', justifyContent: "flex-end", mr: 25, mt: 3 }}>
                ...
                (isLoading) ?
                    ...
                    <Grid container wrap={'nowrap'} columns={2}>
                        ...
                        {(serverData.length === 0) ? (
                            ...
                            <Box><Grid container spacing={6} columns={6} sx={{ margin: 'auto', width: 'auto', padding: '0px', display: 'box' }}>
